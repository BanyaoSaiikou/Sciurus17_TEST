...
#(512, 2048)==>>(64, 50, 512)))
  ...
  def call(self, x, training, mask):
   ...
   #print("!!!!!!!!xxx!!!!!!",x)shape=(None, None, 128)
...
checkpoint_path = "./cwh_study_test/checkpoint/train8"
...
#         print("入力: ",x22[j])
#         print("data: ")
#         print("予測：",translate(x22[j]))
#         print("実際：",change11(y22[j]))
#         print("结果: ",translate(x22[j])==change11(y22[j]))
#         print(" ")
#         check_j+=1
#         print("check_j",check_j)
#         if (translate(x22[j])==change11(y22[j])):
#             check_i+=1
#             print("成功数：",check_i)
...
print("入力: ","0|43 ")
print("予測：",translate("043 "))
print("実際：",change11('16 '))
print("结果: ",translate("043 ")==change11('16 12 5 24 '))
print("----------------------")

print("入力: ","0|43 3|43 19|43 43|43 ")
print("予測：",translate("043 343 1943 4343 "))
print("実際：",change11('16 12 5 24 '))
print("结果: ",translate("043 343 1943 4343 ")==change11('16 12 5 24 '))
print("----------------------")
