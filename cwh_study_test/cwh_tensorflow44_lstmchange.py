...
val_dataset = xy22.map(tf_encode)
val_dataset = val_dataset.filter(filter_max_length).padded_batch(BATCH_SIZE, ((None, ), (None, )))

# for (batch, (inp, tar)) in enumerate(train_dataset):
#     print("1",batch)#0-156
#     print("2",inp)# shape=(64, 23)/(16,10)/(64,15)/(64,19)
#     print("3",tar)# shape=(64, 23)
...
# a=[[1,2,0,0,1]]
# s=tf.math.equal(a,0)
# numpy=array([[False, False,  True,  True, False]])>
#tf。cast = 0 0 1 1 0

    # 添加额外的维度来将填充加到
    # 注意力对数（logits）。
    # print("!!!!!!1",seq[:, tf.newaxis, tf.newaxis, :])
...
class EncoderLayer(tf.keras.layers.Layer):
  ...
  def call(self, x, training, mask):
    ...
    # print("!!!!!!!out2.shape:",out2.shape)(None, None, 128)
    return out2
...
class Encoder(tf.keras.layers.Layer):
    def __init__(self, num_layers, d_model, num_heads, dff, input_vocab_size,
                 maximum_position_encoding, rate=0.1):# Encoder(num_layers, d_model, num_heads, dff, input_vocab_size, pe_input, rate)
        ...
        self.embedding = tf.keras.layers.Embedding(input_vocab_size, d_model)#输入尺寸(batch_size, sequence_length)的 2D 张量。
    ...
    def call(self, x, training, mask):#   (inp, training, enc_padding_mask) 
...
class Transformer(tf.keras.Model):
    ...
    def call(self, inp, tar, training, enc_padding_mask, 
        ...
        # print("!!!!!!!!!enc_output",enc_output.shape) (None, None, 128)
...
# target_vocab_size = encoder_en.vocab_size + 2#提供的形状
input_vocab_size = encoder_pt.vocab_size + 1290
...
checkpoint_path = "./cwh_study_test/checkpoint/train9"
...
#   train_accuracy.reset_states()#no reset is ok
  ...
  viz.line([[train_loss.result(), train_accuracy.result()]], [epoch], win='train', update='append')
    #-----------------------------
...
print("1111111111111")
print("入力: ","0|4 4|4 ")
print("予測：",translate("0 4"))
print("実際：",change11('0 '))
print("----------------------")
print("入力: ","0|4 1|4 4|4 ")
print("予測：",translate("0 1 4"))
print("実際：",change11('0 10 '))
print("----------------------")

print("入力: ","0|4 1|4 9|4 4|4 ")
print("予測：",translate("0 1 9 4 "))
print("実際：",change11('0 10 20 '))
print("----------------------")
...
print("入力: ","0|4 1|4 4|4 ")
print("予測：",translate("0 1 4"))
print("実際：",change11('10 '))
print("----------------------")

print("入力: ","0|4 9|4 4|4 ")
print("予測：",translate("0 9 4 "))
print("実際：",change11('20 '))
print("----------------------")

print("入力: ","0|4 4|4 4|4 ")
print("予測：",translate("0 4 "))
print("実際：",change11('24 '))
print("----------------------")
...
print("実際：",change11('0 10 '))
print("---------外乱-------------")
print("入力: ","0|4 1|4 27|4 4|4 ")
print("予測：",translate("0 1 27 4"))#外乱发生
print("----------------------")
print("入力: ","0|4 27|4 4|4 ")
print("予測：",translate("0 27 4"))#外乱发生
print("----------------------")
...
print("予測：",translate("0 4 "))
print("----------------")
print("入力: ","0|4 2|4 4|4 ")
print("予測：",translate("0 2 4 "))
